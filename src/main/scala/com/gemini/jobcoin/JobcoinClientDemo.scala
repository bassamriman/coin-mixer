...
import JobcoinClientDemo.PlaceholderResponse

class JobcoinClientDemo(config: Config)(implicit materializer: Materializer) {
  private val wsClient = StandaloneAhcWSClient()
  //private val apiAddressesUrl = config.getString("jobcoin.gemini.com/blast-isolating/api")
